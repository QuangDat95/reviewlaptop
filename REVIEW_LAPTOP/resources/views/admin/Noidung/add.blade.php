                        ...
                        <div class="col-12 col-md-12">
                            <div class="row">
                                <div class="col-12" style="padding-top:10px">
                                    <h3 style="color:blue"><b>THÊM NỘI DUNG MỚI</b></h3>
                                </div>
                                <div class="col-12">
                                    <form method="post" action="{{ route('noidung.store') }}">
                                        @csrf
                                        ...
                                        <div class="form-group" style="padding-right:50px">
                                            ...
                                            <input type="textarea" class="form-control" name="ND_ngan"
                                                placeholder="Nhập nội dung ngắn" autocomplete="off">
                                        </div>
                                        <div class="form-group" style="padding-right:50px">
                                            <label>Tên máy</label><br>
                                            <select class="custom-select" name="Ten_may" style="width:100%">
                                                @foreach($tenmays as $value => $tenmay)
                                                <option value="{{$tenmay->id}}">{{$tenmay->Ten_may}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group" style="padding-right:50px">
                                            ...
                                            <input type="text" class="form-control" name="link"
                                                placeholder="Nhập link review" autocomplete="off">
                                        </div>
                                        <div class="form-group" style="padding-right:50px">
