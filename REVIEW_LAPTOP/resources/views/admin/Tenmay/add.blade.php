@extends('admin.home')
@section('content')
@section('title','Thêm danh sách máy')
<body>
    <!--Preloader-->
                    ...
                    <div class="panel-body">
                        <div class="col-12 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form method="post" action="{{ route('tenmay.store') }}" enctype= "multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group" style="padding-right:50px">
                                            ...
                                            <select class="custom-select" name="TL_id" style="width:100%">
                                                @foreach($theloais as $value => $theloai)
                                                <option value="{{$theloai->id}}">{{$theloai->Ten_hang}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group mb-2" style="padding-right:50px">
                                            ...
                                            <div class="form-check" style="padding-right:50px">
                                                <input class="form-check-input" type="checkbox" value="<?= $tinhnang->id; ?>"
                                                    id="tinhnang_<?= $tinhnang->id; ?>" name="tinhnangs[]">
