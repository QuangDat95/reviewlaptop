                    ...
                    <div class="panel-body">
                        <div class="col-12 col-md-12">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form method="post" action="{{ route('tintuc.update',$tintuc->id) }}" enctype= "multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group" style="padding-right:50px">
                                            ...
                                            <textarea name="noi_dung" id="noi_dung" cols="30" rows="10"
                                                required>{{$tintuc->noi_dung}}</textarea>
                                        </div>
