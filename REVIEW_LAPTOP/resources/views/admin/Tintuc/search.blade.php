    ...
    <div class="wrapper  theme-3-active pimary-color-blue">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="mobile-only-brand pull-left">
                ...
                <form action="{{route('tintucsearch')}}" method="GET" id="search_form" role="search" class="top-nav-search collapse pull-left">
                ...
                <div>
                    <div class="panel-body">
                        <p class="text-muted" style="padding-top:50px"><a class="btn btn-primary"
                                href="{{ route('tintuc.create') }}">Thêm tin tức</a></p>
                                <p>Tìm thấy {!! count($tintucs) !!} danh mục với từ khóa "<?php echo $key?>"</p>      
                        <div class="mt-40">
                            ...
                            <div>
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        @if(count($tintucs) == 0)
                                        <tr>
                                            <td colspan="3">Không có tin tức nào</td>
                                        </tr>
                                        @else
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ Storage::url($tintuc->hinh_anh) }}" style="height: 5cm"></td>
                                            <td>
                                                <form action="{{route('tintuc.destroy', $tintuc->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('tintuc.edit', $tintuc->id)}}"
