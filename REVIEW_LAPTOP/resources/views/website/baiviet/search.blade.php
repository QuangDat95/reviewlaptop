                    ...
                    <div class="jl_grid_wrap_f jl_clear_at g_3col">
                        <div class="jl-roww content-inner jl-col3 jl-col-row">
                            <div class="jl_sec_title">
                                ...
                                <p>Tìm thấy {!!count($searchreview)!!} bài viết với từ khóa "{!!$req->key!!}"</p>
                            </div>
                            <!--startloop-->
                            @foreach($searchreview as $review)                             
                                    <div class="jl-grid-cols">
                                        <div class="p-wraper post-2959">
                                            <div class="jl_grid_w">
                                                <div class="jl_img_box jl_radus_e"><a href="{{route('readreview',$review->id)}}"><img width="500"
                                                            height="350"
                                                ...
                                                <div class="text-box">
                                                    <h3><a href="{{route('readreview',$review->id)}}">{{$review->maytinh->Ten_may}}</a></h3><span class="jl_post_meta"> <span
                                                            class="jl_author_img_w"><i class="jli-user"></i><a href="{{route('readreview',$review->id)}}"
                                                                title="Posts by Spraya"
                                                                rel="author">Review</a></span><span class="post-date"><i
