                                ...
                                <div class="menu-primary-container navigation_wrapper jl_cus_share_mnu">
                                    <ul id="mainmenu" class="jl_main_menu">
                                        <li class="menu-item current-menu-item current_page_item"> <a
                                                href="{{route('home')}}">Trang chủ<span class="border-menu"></span></a>
                                        </li>
                                        <li class="menu-item menu-item-has-children"> <a
                                                href="{{route('homereview')}}">Tất cả các hãng<span
                                        ...
                                        <li class="menupost"> <a href="{{route('homenew')}}">Tin tức<span
                                        ...
                                        <li class="menu-item menu-item-has-children"> <a>Cửa
                                                hàng</a><span class="border-menu"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"> <a href="https://www.thegioididong.com/">Thế giới
                                                        di động <span class="border-menu" style="padding-left:40px"><img
                                        ...
                                        <li class="menu-item"> <a href="{{route('theloai.index')}}">Trang quản lý<span
